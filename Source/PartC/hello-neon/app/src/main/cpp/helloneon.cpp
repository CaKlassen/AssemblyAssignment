...
extern "C" jfloatArray Java_com_example_helloneon_MyGLRenderer_mmult( JNIEnv* env, jobject thiz, jfloatArray a, jfloatArray b)
{
    ...
    resCol1 = vmlaq_n_f32(resCol1, M1secondCol,scalar);
    scalar = float32_t(bMatrix[2]);
    resCol1 = vmlaq_n_f32(resCol1, M1thirdCol,scalar);
    scalar = float32_t(bMatrix[3]);
    resCol1 = vmlaq_n_f32(resCol1, M1fourthCol,scalar);
    ...
    resCol2 = vmlaq_n_f32(resCol2, M1secondCol,scalar);
    scalar = float32_t(bMatrix[6]);
    resCol2 = vmlaq_n_f32(resCol2, M1thirdCol,scalar);
    scalar = float32_t(bMatrix[7]);
    resCol2 = vmlaq_n_f32(resCol2, M1fourthCol,scalar);

    //third column
    scalar = float32_t(bMatrix[8]);
    float32x4_t resCol3 = vmulq_n_f32(M1firstCol, scalar);
    scalar = float32_t(bMatrix[9]);
    resCol3 = vmlaq_n_f32(resCol3, M1secondCol,scalar);
    scalar = float32_t(bMatrix[10]);
    resCol3 = vmlaq_n_f32(resCol3, M1thirdCol,scalar);
    scalar = float32_t(bMatrix[11]);
    resCol3 = vmlaq_n_f32(resCol3, M1fourthCol,scalar);

    //fourth column
    scalar = float32_t(bMatrix[12]);
    float32x4_t resCol4 = vmulq_n_f32(M1firstCol, scalar);
    scalar = float32_t(bMatrix[13]);
    resCol4 = vmlaq_n_f32(resCol4, M1secondCol,scalar);
    scalar = float32_t(bMatrix[14]);
    resCol4 = vmlaq_n_f32(resCol4, M1thirdCol,scalar);
    scalar = float32_t(bMatrix[15]);
    resCol4 = vmlaq_n_f32(resCol4, M1fourthCol,scalar);
